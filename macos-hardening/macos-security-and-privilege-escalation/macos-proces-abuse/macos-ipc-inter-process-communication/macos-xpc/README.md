...
int main(int argc, const char *argv[]) {
    xpc_connection_t service = xpc_connection_create_mach_service("xyz.resources.service",
...
int main(int argc, const char *argv[]) {
    xpc_connection_t connection = xpc_connection_create_mach_service("xyz.resources.service", NULL, XPC_CONNECTION_MACH_SERVICE_PRIVILEGED);
...
{% tab title="xyz.resources.service.plist" %}
```xml
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd"> <plist version="1.0">
<dict>
<key>Label</key>
<string>xyz.resources.service</string>
<key>MachServices</key>
    <dict>
        <key>xyz.resources.service</key>
        <true/>
    </dict>
<key>Program</key>
...
# Load daemon
sudo cp xyz.resources.service.plist /Library/LaunchDaemons
sudo launchctl load /Library/LaunchDaemons/xyz.resources.service.plist

# Call client
./xpc_client

# Clean
sudo launchctl unload /Library/LaunchDaemons/xyz.resources.service.plist
sudo rm /Library/LaunchDaemons/xyz.resources.service.plist /tmp/xpc_server
```
...
int main(void) {
    ...
    NSXPCListener *listener = [[NSXPCListener alloc] initWithMachServiceName:@"xyz.resources.svcoc"];
...
int main(void) {
    NSXPCConnection *connection = [[NSXPCConnection alloc] initWithMachServiceName:@"xyz.resources.svcoc" options:NSXPCConnectionPrivileged];
...
{% tab title="xyz.resources.svcoc.plist" %}
```xml
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd"> <plist version="1.0">
<dict>
<key>Label</key>
<string>xyz.resources.svcoc</string>
<key>MachServices</key>
    <dict>
        <key>xyz.resources.svcoc</key>
        <true/>
    </dict>
<key>Program</key>
...
# Load daemon
sudo cp xyz.resources.svcoc.plist /Library/LaunchDaemons
sudo launchctl load /Library/LaunchDaemons/xyz.resources.svcoc.plist

# Call client
./oc_xpc_client

# Clean
sudo launchctl unload /Library/LaunchDaemons/xyz.resources.svcoc.plist
sudo rm /Library/LaunchDaemons/xyz.resources.svcoc.plist /tmp/oc_xpc_server
```
...
{
        NSString*  _serviceName = @"xyz.resources.svcoc";
