...
* The SIP protected file **`/Users/khulnasoft/Downloads/REG.db`** (also protected from read access with TCC), contains the **location** of all the **valid TCC databases**.
* The SIP protected file **`/Users/khulnasoft/Downloads/MDMOverrides.plist`** (also protected from read access with TCC), contains more TCC granted permissions.
