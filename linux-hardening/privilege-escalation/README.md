...
If don't mind about doing a lot of noise and `su` and `timeout` binaries are present on the computer, you can try to brute-force user using [su-bruteforce](https://github.com/khulnasoft/su-bruteforce).\
[**Linpeas**](https://github.com/khulnasoft/privilege-escalation-awesome-scripts-suite) with `-a` parameter also try to brute-force users.
...
Read the code of [**linPEAS**](https://github.com/khulnasoft/privilege-escalation-awesome-scripts-suite/tree/master/linPEAS), it searches for **several possible files that could contain passwords**.\
...
I'm not going to list here how to do all of this but if you are interested you can check the last checks that [**linpeas**](https://github.com/khulnasoft/privilege-escalation-awesome-scripts-suite/blob/master/linPEAS/linpeas.sh) perform.
...
### **Best tool to look for Linux local privilege escalation vectors:** [**LinPEAS**](https://github.com/khulnasoft/privilege-escalation-awesome-scripts-suite/tree/master/linPEAS)
