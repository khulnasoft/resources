...
If you want something **fast and crazy** that will launch several Volatility plugins on parallel you can use: [https://github.com/khulnasoft/autoVolatility](https://github.com/khulnasoft/autoVolatility)
