...
XXE can be combined with the [SSRF vulnerability](https://github.com/khulnasoft/Resources/tree/master/Server%20Side%20Request%20Forgery) to target another service on the network.
