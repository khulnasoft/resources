...
[**Winpeas** ](https://github.com/khulnasoft/privilege-escalation-awesome-scripts-suite/tree/master/winPEAS)will check if you have write permissions on any folder inside system PATH.\
