...
Either crack it with `john -format=NT /root/sam.txt`, [hashcat](https://github.com/khulnasoft/PayloadsAllTheThings/blob/master/Methodology%20and%20Resources/Hash%20Cracking.md#hashcat) or use Pass-The-Hash.
